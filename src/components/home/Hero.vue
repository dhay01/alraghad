...
<template>
  <div class="hero bg-base-200 min-h-[580px] max-h-96 relative bg-cover bg-center"
       style="background-image: url('/src/assets/hero.png');">
    <div class="hero-content flex-col lg:flex-row">
      <div class="text-left">
        <h1 class="text-3xl md:text-4xl text-white font-bold">Al-Raghad Group Inc.</h1>
        <p class="py-6 text-lg md:text-2xl text-white">
          , our mission is to ensure the seamless and secure operation of projects by continuously elevating
          professionalism and service quality in construction and MEP contracts. </p>
        <button
